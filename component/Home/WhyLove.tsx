    ...
    <div className="pt-120">
      <div className="container">
        <div className="max-w-[709px] mx-auto space-y-3 text-center">
          <h2 className="title max-w-[562px] mx-auto">Why Restaurant Owners Love RestruHub</h2>
          <p className="desc">
           Powerful features designed specifically for busy restaurant owners who want to maintain excellent customer relationships.
          </p>
        </div>
        ...
        <div className="pt-60 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {data.map((item, index) => (
            <div
              key={index}
              className="bg-white flex-col  rounded-xl py-5 px-3 lg:py-9 lg:px-6  flex border border-[#0000000D] "
            ...
            >
              ...
              <p className="text-sm md:text-[16px] text-[#5a6370]">{item.des}</p>
            </div>
          ))}
        </div>
      </div>
